LOADER_CONFIG = {
    ...
    "round_config": {
        ...
        "instructions_json": {
            "en": "<p class='govuk-body'>We'll be accepting applications continuously and formally reviewing them in batches.<br><br>You can submit your application by midday on 29 July 2025 to be considered for our first cohort, with onboarding starting in September 2025.<br><br>If you submit an application after 29 July 2025, we will automatically consider it for the next cohort and contact you with further details later in the year.<br><br>This approach allows us to provide high-quality support, by onboarding councils in coordinated groups.<br><br>While this is not a competitive funding process, we will ask questions to assess your readiness to receive the funding and begin the work.</p>",
            "cy": None,
        },
        "feedback_link": "",
