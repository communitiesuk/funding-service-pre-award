LOADER_CONFIG = {
    ...
    "round_config": {
        ...
        "instructions_json": {
            "en": "If you have not received the prospectus, visit [Home | Local Digital EMMA TO SUPPLY URL ON TUESDAY] or contact digitalplanningteam@communities.gov.uk",
            "cy": None,
        },
        "feedback_link": "",
        "project_name_field_id": "JAAhRP",
        "application_guidance_json": {
            "en": "<h2 class='govuk-heading govuk-heading-s'>What we'll ask you for</h2> <p class='govuk-body'>We have outlined the information needed to complete the application in our <a class='govuk-link' target='_blank' href='https://www.localdigital.gov.uk/digital-planning/digital-planning-improvement-fund-2025-2026/'>prospectus</a>. If you have not received the prospectus, contact digitalplanningteam@communities.gov.uk</p> <p class='govuk-body'>You can preview the <a href='{all_questions_url}' target='_blank'>full list of application questions</a>.</p>",
            "cy": None,
        },
