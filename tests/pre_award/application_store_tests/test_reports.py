...
def test_get_application_statuses_csv(flask_test_client, seed_application_records, db):
    ...
    assert f"{test_application_data[0]['fund_id']},{test_application_data[0]['round_id']},1,0,0,0,0,0,0" in lines
    assert f"{test_application_data[1]['fund_id']},{test_application_data[1]['round_id']},1,0,0,0,0,0,0" in lines
    assert f"{test_application_data[2]['fund_id']},{test_application_data[2]['round_id']},1,0,0,0,0,0,0" in lines
    ...
    assert f"{test_application_data[0]['fund_id']},{test_application_data[0]['round_id']},0,1,0,0,0,0,0" in lines
    assert f"{test_application_data[1]['fund_id']},{test_application_data[1]['round_id']},1,0,0,0,0,0,0" in lines
    assert f"{test_application_data[2]['fund_id']},{test_application_data[2]['round_id']},1,0,0,0,0,0,0" in lines
